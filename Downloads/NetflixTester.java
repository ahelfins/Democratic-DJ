...
public class NetflixTester {
	...
	public static final String baseFile = "u1.base";
	public static final String testFile = "u1.test";

	public static final String usersFile = "u.user";
	public static final String moviesFile = "u.item";
