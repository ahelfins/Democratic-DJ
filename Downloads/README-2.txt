...
Responsibility List: 
	...
	Ashley Helfinstein: Coding sheetMusic classes (placement of notes on sheet music), edit Note and Instruments classes, find audio of notes from different instruments, Find the Image
